...
export default function Wraq({image,direction,text,title}:any) {
  return (
      ...
      <div className="flex pt-12 px-6 md:px-20  items-center justify-center bg-hero md:h-screen overflow-hidden">
        <div className="flex flex-col  gap-6 md:flex-row items-center max-w-8xl">
          ...
          <div className="w-full md:w-1/2 lg:pr-32">
            <ScrollAppear>
              <h2 className="text-4xl lg:text-5xl text-right md:text-left text-blue-900 leading-tight font-medium ">
                {title}
              </h2>
            </ScrollAppear>
            ...
            {direction == "left" && (
              <ScrollAppear>
                <Image src={woraq} width={1000} height={400} alt="image" />
              </ScrollAppear>
            )}
